        ...
        def initiate_data_transformer(self)-> DataTransformationArtifact:
            ...
            try:
                if self.data_validation_artifact.validation_status:
                    ...
                    logging.info("ID and Yr of establishmant columns are dropped from the train dataframe")
                    ...
                    drop_columns= self.schema_config[drop_columns]
                    input_feature_test_df = drop_columns(df=input_feature_train_df,cols=[drop_columns])
                    logging.info("ID and Yr of establishmant columns are dropped from the test dataframe")
